...
## Project Structure
    ...
    ├── testapiautoteammemb_95676  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_95676`
...
2. Clone this repo and `cd testapiautoteammemb_95676`
